...
def show_spinner(angle,color,dark_color):
    ...
    centre=[x,y,d,d]
    centre_inner=[x + d/2 - innerd/2,y + d/2 - innerd/2, innerd,innerd]#set diameter formula
...
def show_info(friction,speed):
    ...
    friction_text= font.render("Friction:" + str(friction),True, white)
    speed_text= font.render("Rate of Change of Angle:" + str(speed),True, white)
    display.blit(speed_text, (15,15))
    display.blit(friction_text, (15,45))
